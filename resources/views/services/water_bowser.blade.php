			...
			<div class="row">
				<div class="span8">	
					<ul class="breadcrumb">
						...
						<li class="active"> {{ __('Water Bowser') }} </li>					
					</ul>
				</div>
				<div class="span4">
					<div class="search">
	...
	<div class="span12">
		...
		<div class="call-action">
			...
			<div class="text">
				...
				<button  class="btn-inverse"> <a href="/en/s/cutTree_apply" class="appLink"> {{ __('Apply online') }} </a> </button>
				<button  class="btn-inverse"> <a href="/en/s/cutTree_apply" class="appLink"> {{ __('Download Application') }} </a> </button>
			</div>		
		</div>			
	</div>
<div>	
