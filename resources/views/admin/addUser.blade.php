...
<div class="row">
	<div class="col-lg-12">
		<section class="panel">
			<header class="panel-heading"> Add Users </header>
			<div class="panel-body">		
			{!! Form::open(['method'=>'POST','class' => 'form-horizontal','action'=>'adminUserController@store','files'=>true]) !!}
				...
				<div class='form-group'>
					...
					<div class="col-sm-10">
					{!! Form::select('gender', array(0=> 'Male', 1=> 'Female') , null,['class'=>'form-control']) !!}
					<!-- /*validation errors*/ -->
				...
				<div class='form-group'>
					...
					<div class="col-sm-10">
					{!! Form::select('civilstatus', array(0=> 'Single', 1=> 'Married') , null,['class'=>'form-control']) !!}
					<!-- /*validation errors*/ -->
				...
				<div class='form-group'>
					{!! Form::label('dtype','User Type:',['class'=>'col-sm-2 control-label']) !!}
					<div class="col-sm-10">
					{!! Form::select('dtype', array(2=> 'Officer', 3=> 'Member') , null,['class'=>'form-control']) !!}
					<!-- /*validation errors*/ -->
					@if ($errors->has('dtype'))
						<span class="help-block">
